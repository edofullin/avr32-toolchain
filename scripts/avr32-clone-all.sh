...
# binutils and gdb
clone_tool origin binutils https://github.com/GomSpace/avr32-binutils-gdb.git
clone_tool origin gcc      https://github.com/GomSpace/avr32-gcc.git
clone_tool origin newlib   https://github.com/GomSpace/avr32-newlib.git
cp -rd binutils gdb
